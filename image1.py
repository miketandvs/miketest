...
#    self.end_effector_pub = rospy.Publisher("end_effector_prediction",Float64MultiArray, queue_size=10)
  ...
  def detect_red(self,image):
      ...
      if (M['m00'] == 0):
        cx=0
        cy=0
        print("Red image NOT detected in image 1")
      else:
        cx = int(M['m10'] / M['m00'])
        cy = int(M['m01'] / M['m00'])
  ...
  def detect_green(self,image):
      ...
      if (M['m00'] == 0):
        cx=0
        cy=0
        print("Green image NOT detected in image 1")
      else:
        cx = int(M['m10'] / M['m00'])
        cy = int(M['m01'] / M['m00'])
      return np.array([cx, cy])
  ...
  def detect_blue(self,image):
      ...
      if (M['m00'] == 0):
        cx=0
        cy=0
        print("Blue image NOT detected in image 1")
      else:
        cx = int(M['m10'] / M['m00'])
        cy = int(M['m01'] / M['m00'])
      return np.array([cx, cy])
  ...
  def detect_yellow(self,image):
      ...
      if (M['m00'] == 0):
        cx=0
        cy=0
        print("Yellow image NOT detected in image 1")
      else:
        cx = int(M['m10'] / M['m00'])
        cy = int(M['m01'] / M['m00'])
      return np.array([cx, cy])
  ...
  def callback1(self,data):
    ...
    self.end_effector_pos= self.detect_end_effector(cv_image)
    self.target_pos= self.detect_target(cv_image)
